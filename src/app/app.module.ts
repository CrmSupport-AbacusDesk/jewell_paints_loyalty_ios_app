...
import { ScanPointPageModule } from '../pages/scan-point/scan-point.module';
import { TopContractorPageModule } from '../pages/top-contractor/top-contractor.module';
import { TopContractorDetailPageModule } from '../pages/top-contractor-detail/top-contractor-detail.module';
...
import { CongratulationsPageModule } from '../pages/congratulations/congratulations.module';
import { SchemeDetailPageModule } from '../pages/scheme-detail/scheme-detail.module';
import { SchemeListPageModule } from '../pages/scheme-list/scheme-list.module';
import { VideoCategoryListPageModule } from '../pages/video-category-list/video-category-list.module';
import { DealerDealerListPageModule } from '../pages/dealer-dealer-list/dealer-dealer-list.module';
import { Market } from '@ionic-native/market';
import { PainterCouponCodePageModule } from '../pages/painter-coupon-code/painter-coupon-code.module';
