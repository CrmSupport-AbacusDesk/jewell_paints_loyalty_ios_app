...
import { ScanPointPage } from '../scan-point/scan-point';
import { TopContractorPage } from '../top-contractor/top-contractor';
import { CongratulationsPage } from '../congratulations/congratulations';
import { SchemeListPage } from '../scheme-list/scheme-list';
import { VideoCategoryListPage } from '../video-category-list/video-category-list';
import { DealerDealerListPage } from '../dealer-dealer-list/dealer-dealer-list';
import { PainterCouponCodePage } from '../painter-coupon-code/painter-coupon-code';
...
export class HomePage {
    ...
    scanGo(){
        this.navCtrl.push(ScanPointPage,{'user_type':this.karigar_detail.user_type})
    }
    

    scanGoPainter(){
        this.navCtrl.push(PainterCouponCodePage)
    }
...
goOnPointeListPage(){
    this.navCtrl.push(PointListPage, {'referral':'scanned'});
...
goOnScheme()
{
    this.navCtrl.push(SchemeListPage, {'userType':this.karigar_detail.user_type});
}
...
gotoHistory(type)
{
    this.navCtrl.push(TransactionPage, {"type":type})
}
goOnGiftGallary()
{
...
goOnVideoPage()
{
    this.navCtrl.push(VideoCategoryListPage);
}
goOnContactPage()
{
...
gotoContractor()
{
    this.navCtrl.push(TopContractorPage);
}
share()
{
    ...
    let image = "";
    let app_url = "https://play.google.com/store/apps/details?id=com.jewellpaints.app";
