...
export class RegistrationPage {
    ...
    getDealerList(district) {
        ...
        this.service.post_rqst({ 'district': district }, 'app_karigar/getDealers').subscribe(r => {
            console.log(r);
            this.dealers = r['dealers'];
            for (let i = 0; i < this.dealers.length; i++) {
                if (this.dealers[i].company_name == null) {
                    this.dealers[i].company_name = ''
                }

                if (this.dealers[i].mobile_no == null) {
                    this.dealers[i].mobile_no = ''
                }

                if (this.dealers[i].company_name != "" || this.dealers[i].mobile_no != "") {
                    this.dealers[i].company_name = this.dealers[i].company_name + '(' + this.dealers[i].mobile_no + ')'
                    
                    
                }
                if (this.dealers[i].company_name == "" && this.dealers[i].mobile_no == "") {
                    this.dealers[i].company_name = this.dealers[i].company_name
                }
